...
If First Principles is already in your `AGENTS.md`, place Attention Allocation AFTER it. Order:
1. First Principles (reasoning input quality layer)
2. Attention Allocation (resource focus layer)
